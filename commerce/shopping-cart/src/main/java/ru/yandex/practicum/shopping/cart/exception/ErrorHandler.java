...
public class ErrorHandler {
    ...
    public ErrorResponse handleNoProducts(NoProductsInCartException e) {
        return new ErrorResponse(e.getMessage());
    }

    @ExceptionHandler(ProductInShoppingCartLowQuantityInWarehouse.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse NoQuantity(ProductInShoppingCartLowQuantityInWarehouse e) {
        return new ErrorResponse(e.getMessage());
    }

    @ExceptionHandler(ActiveCartNotFoundException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleCartDeactivated(ActiveCartNotFoundException e) {
        return new ErrorResponse(e.getMessage());
    }
